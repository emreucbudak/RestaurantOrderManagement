...
public partial class WaiterManagementPage : ContentPage
{
    ...
    private async void OnWaiterAddedButtonClicked(object sender, EventArgs e)
    {
        ...
        var response = await client.PostAsync("http://127.0.0.1:8000/register/user", content);
        ...
        {
            await DisplayAlertAsync("Hata", "Garson eklenemedi", "OK");
        }
    }
}
